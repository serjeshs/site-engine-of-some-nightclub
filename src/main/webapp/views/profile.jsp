					...
					<div class="grid_7">
						...
						<form method="POST" action="saveprofileupdate" id="contact-form" enctype="multipart/form-data">
							<fieldset>
								...
								<label>
								Никнейм
								<input id="nick" type="text" name="nick" value="${appUser.nick}">	</label>
								<label>
								Фамилия
								<input id="surname" type="text" name="surname" value="${appUser.surname}">	</label>
								<label>
								Имя
								<input id="firstname" type="text" name="firstname" value="${appUser.firstname}">	</label>
								<label>
								Отчество
								<input id="fathername" type="text" name="fathername" value="${appUser.fathername}">	</label>
